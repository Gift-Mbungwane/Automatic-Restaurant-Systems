...
public class Order extends javax.swing.JFrame {
     ...
     */
    public Order(int UserLogin, String order,int hall,String table) {
        this.order=order;
        this.hall=hall;
        this.table=table;
    ...
    private void updateTable()
    {
        ...
        try {
            ...
            String sql1 = "SELECT productsID, quantity FROM order_product WHERE OrderID="+orderID;
            rs1 = stmt1.executeQuery(sql);
            int i=0;
            while(rs1.next())
            {
                productID = rs1.getInt("productsID");
                ...
                try
                {
                    //  if(productID!=0 && quantity!=0)
                    {
                        ...
                        jTable1.getModel().setValueAt(productID, i, 0);
                        jTable1.getModel().setValueAt(quantity, i, 1);
                        jTable1.getModel().setValueAt(name, i, 2);
                        jTable1.getModel().setValueAt(price, i, 3);

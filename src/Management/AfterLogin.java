...
public class AfterLogin extends javax.swing.JFrame {
    ...
    private void ScheduleClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        //to do: grafik
    ...
    private void ManagerFunctionsClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
    ...
    private void TableClicked(java.awt.event.MouseEvent evt) {
        ...
        pom_hall =  model.getValueAt(selectedRowIndex, 1).toString();
        hall = Integer.valueOf(pom_hall);
        table = model.getValueAt(selectedRowIndex, 2).toString();

...
public class AddToDatabase extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/minus.png"))); // NOI18N
        jLabel13.setText("DELETE FROM DATABASE");
        ...
        try {
            ...
            switch(option)
            {
                case "Employee":
                    ...
                    sql = "INSERT INTO employees (reportsTo, RestaurantCode, LastName, FirstName, Position, Password)"
                            + " values (?, ?, ?, ?, ?, ?)";
                ...
                case "Table":
                   ...
                   pom = jTextField2.getText();
                    ...
                    pom = jTextField3.getText();
                    int2 = Integer.parseInt(pom);
                    sql = "INSERT INTO tables (IDRoom, Status, Size) values (?, 'free', ?)";
                    stmt = conn.prepareStatement(sql);
                    ((PreparedStatement) stmt).setInt(1,int1);
                    ((PreparedStatement) stmt).setInt(2,int2);
                    stmt.executeUpdate();*/
                ...
                case "Product":
                    ...
                    int2 = Integer.parseInt(pom);
                    sql = "INSERT INTO products (MenuID, Name, Price, Description, QuantityInStock) values (?,?,?,?,?)";
                    stmt = conn.prepareStatement(sql);
                    ((PreparedStatement) stmt).setInt(1,int1);
                    ((PreparedStatement) stmt).setString(2,string1);
